...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/zlz1zl) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/zlz1zl) /ZE \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/zlz1zl)\n [🔱 سورس علي احمد 🔱](https://t.me/zlz1zl)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/zlz1zl) """,
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/zlz1zl) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/zlz1zl) \n ※[These Features AI Based](https://t.me/zlz1zl)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="zlz1zl"),
                ],
                [                
                    InlineKeyboardButton(" Commands", callback_data="cbcmds"),
                    InlineKeyboardButton(" Donate", url=f"https://t.me/zlz1zl"),
                ],
                [
                    InlineKeyboardButton(
                        " DEVELOPER ", url="https://t.me/TFFF_F"
                    )
                ],
            ]
        ),
...
@Client.on_callback_query(filters.regex("zlz1zl"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🔱 **※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع زد إي من هن : @zlz1zl **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
