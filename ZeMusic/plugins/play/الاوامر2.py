...
※ استخدم الازرار لمعرفه الاوامر المستخدمه. """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱", url=f"https://t.me/zlz1zl"),
...
InlineKeyboardButton(" member keyboard ", callback_data="Q_XUQ"),
                ...
                [
                    InlineKeyboardButton(
                        "🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱", url=f"https://t.me/zlz1zl"
                    ),
                    InlineKeyboardButton(
...
\n√ **في حال واجهت اي مشكلة اخرى يمكنك التواصل مع المطور من هنا : @TFFF_F **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
